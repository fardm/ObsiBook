...
## وضعیت
برای سهولت بیشتر من پلاگین [Book Clipper](https://github.com/fardm/obsidian-book-clipper) رو را بر اساس همین عملکرد توسعه دادم. به جای اکستنشن میتوانید از این پلاگین استفاده کنید.

قبلا هم یک [اسکریپت](https://github.com/fardm/ObsiBook/tree/script) از همین اکستنشن آماده کردم بودم که نیاز به مرورگر ندارد و مسقیما در خود نرم افزار ابسیدین اجرا می شود. 
